...
print()
print("printing specific values")
...
print()
print("A 2D array initialized to zero")
...
print()
print("A 2D array initialized to ones")
# A 2D array initialized to ones
x = np.ones([10,5], dtype = int) 
print (x)

print()
print("generate an array with start and stop parameters set ")
# generate an array with start and stop parameters set 
x = np.arange(10,20,2) 
print (x)

print()
print("generate an array of evenly spaced numbers between a given range ")
